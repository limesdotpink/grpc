...
const file_api_user_connections_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/user_connections.proto\x12\x03api\"#\n" +
	...
	"\n" +
	"_tier_name\"r\n" +
	"\x0fUserConnections\x120\n" +
	"\adiscord\x18\x01 \x01(\v2\x16.api.DiscordConnectionR\adiscord\x12-\n" +
	"\x06stripe\x18\x02 \x01(\v2\x15.api.StripeConnectionR\x06stripeBs\n" +
	"\acom.apiB\x14UserConnectionsProtoP\x01Z&github.com/PretendoNetwork/grpc/go/api\xa2\x02\x03AXX\xaa\x02\x03Api\xca\x02\x03Api\xe2\x02\x0fApi\\GPBMetadata\xea\x02\x03Apib\x06proto3"

var (
	file_api_user_connections_proto_rawDescOnce sync.Once
	file_api_user_connections_proto_rawDescData []byte
)

func file_api_user_connections_proto_rawDescGZIP() []byte {
	file_api_user_connections_proto_rawDescOnce.Do(func() {
		file_api_user_connections_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_user_connections_proto_rawDesc), len(file_api_user_connections_proto_rawDesc)))
	})
...
func file_api_user_connections_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_user_connections_proto_rawDesc), len(file_api_user_connections_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
