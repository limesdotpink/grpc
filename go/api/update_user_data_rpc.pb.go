...
const file_api_update_user_data_rpc_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/update_user_data_rpc.proto\x12\x03api\"\x17\n" +
	"\x15UpdateUserDataRequestBu\n" +
	"\acom.apiB\x16UpdateUserDataRpcProtoP\x01Z&github.com/PretendoNetwork/grpc/go/api\xa2\x02\x03AXX\xaa\x02\x03Api\xca\x02\x03Api\xe2\x02\x0fApi\\GPBMetadata\xea\x02\x03Apib\x06proto3"

var (
	file_api_update_user_data_rpc_proto_rawDescOnce sync.Once
	file_api_update_user_data_rpc_proto_rawDescData []byte
)

func file_api_update_user_data_rpc_proto_rawDescGZIP() []byte {
	file_api_update_user_data_rpc_proto_rawDescOnce.Do(func() {
		file_api_update_user_data_rpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_update_user_data_rpc_proto_rawDesc), len(file_api_update_user_data_rpc_proto_rawDesc)))
	})
...
func file_api_update_user_data_rpc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_update_user_data_rpc_proto_rawDesc), len(file_api_update_user_data_rpc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
