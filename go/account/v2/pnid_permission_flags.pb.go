...
func (x *PNIDPermissionFlags) Reset() {
	*x = PNIDPermissionFlags{}
	mi := &file_account_v2_pnid_permission_flags_proto_msgTypes[0]
...
func (*PNIDPermissionFlags) Descriptor() ([]byte, []int) {
	return file_account_v2_pnid_permission_flags_proto_rawDescGZIP(), []int{0}
}
...
var File_account_v2_pnid_permission_flags_proto protoreflect.FileDescriptor

const file_account_v2_pnid_permission_flags_proto_rawDesc = "" +
	"\n" +
	"&account/v2/pnid_permission_flags.proto\x12\n" +
	"account.v2\"\xd8\a\n" +
	...
	"\x17update_pnid_permissions\x18\x16 \x01(\bR\x15updatePnidPermissionsB\xac\x01\n" +
	"\x0ecom.account.v2B\x18PnidPermissionFlagsProtoP\x01Z7github.com/PretendoNetwork/grpc/go/account/v2;accountv2\xa2\x02\x03AXX\xaa\x02\n" +
	"Account.V2\xca\x02\n" +
	"Account\\V2\xe2\x02\x16Account\\V2\\GPBMetadata\xea\x02\vAccount::V2b\x06proto3"

var (
	file_account_v2_pnid_permission_flags_proto_rawDescOnce sync.Once
	file_account_v2_pnid_permission_flags_proto_rawDescData []byte
)

func file_account_v2_pnid_permission_flags_proto_rawDescGZIP() []byte {
	file_account_v2_pnid_permission_flags_proto_rawDescOnce.Do(func() {
		file_account_v2_pnid_permission_flags_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_account_v2_pnid_permission_flags_proto_rawDesc), len(file_account_v2_pnid_permission_flags_proto_rawDesc)))
	})
	return file_account_v2_pnid_permission_flags_proto_rawDescData
}

var file_account_v2_pnid_permission_flags_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_account_v2_pnid_permission_flags_proto_goTypes = []any{
	(*PNIDPermissionFlags)(nil), // 0: account.v2.PNIDPermissionFlags
}
var file_account_v2_pnid_permission_flags_proto_depIdxs = []int32{
...
func init() { file_account_v2_pnid_permission_flags_proto_init() }
func file_account_v2_pnid_permission_flags_proto_init() {
	if File_account_v2_pnid_permission_flags_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_account_v2_pnid_permission_flags_proto_rawDesc), len(file_account_v2_pnid_permission_flags_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_account_v2_pnid_permission_flags_proto_goTypes,
		DependencyIndexes: file_account_v2_pnid_permission_flags_proto_depIdxs,
		MessageInfos:      file_account_v2_pnid_permission_flags_proto_msgTypes,
	}.Build()
	File_account_v2_pnid_permission_flags_proto = out.File
	file_account_v2_pnid_permission_flags_proto_goTypes = nil
	file_account_v2_pnid_permission_flags_proto_depIdxs = nil
}
