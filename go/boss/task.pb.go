...
const file_boss_task_proto_rawDesc = "" +
	"\n" +
	"\x0fboss/task.proto\x12\x04boss\"\xbe\x02\n" +
	"\x04Task\x12\x18\n" +
	...
	" \x01(\x04R\x10updatedTimestampBn\n" +
	"\bcom.bossB\tTaskProtoP\x01Z'github.com/PretendoNetwork/grpc/go/boss\xa2\x02\x03BXX\xaa\x02\x04Boss\xca\x02\x04Boss\xe2\x02\x10Boss\\GPBMetadata\xea\x02\x04Bossb\x06proto3"

var (
	file_boss_task_proto_rawDescOnce sync.Once
	file_boss_task_proto_rawDescData []byte
)

func file_boss_task_proto_rawDescGZIP() []byte {
	file_boss_task_proto_rawDescOnce.Do(func() {
		file_boss_task_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_boss_task_proto_rawDesc), len(file_boss_task_proto_rawDesc)))
	})
...
func file_boss_task_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_boss_task_proto_rawDesc), len(file_boss_task_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
