...
func (x *RegisterTaskRequest) Reset() {
	*x = RegisterTaskRequest{}
	mi := &file_boss_v2_register_task_proto_msgTypes[0]
...
func (*RegisterTaskRequest) Descriptor() ([]byte, []int) {
	return file_boss_v2_register_task_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegisterTaskResponse) Reset() {
	*x = RegisterTaskResponse{}
	mi := &file_boss_v2_register_task_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterTaskResponse) Descriptor() ([]byte, []int) {
	return file_boss_v2_register_task_proto_rawDescGZIP(), []int{1}
}
...
var File_boss_v2_register_task_proto protoreflect.FileDescriptor
...
var (
	file_boss_v2_register_task_proto_rawDescOnce sync.Once
	file_boss_v2_register_task_proto_rawDescData []byte
)

func file_boss_v2_register_task_proto_rawDescGZIP() []byte {
	file_boss_v2_register_task_proto_rawDescOnce.Do(func() {
		file_boss_v2_register_task_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_boss_v2_register_task_proto_rawDesc), len(file_boss_v2_register_task_proto_rawDesc)))
	})
	return file_boss_v2_register_task_proto_rawDescData
}

var file_boss_v2_register_task_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_boss_v2_register_task_proto_goTypes = []any{
	(*RegisterTaskRequest)(nil),  // 0: boss.v2.RegisterTaskRequest
	(*RegisterTaskResponse)(nil), // 1: boss.v2.RegisterTaskResponse
	(*Task)(nil),                 // 2: boss.v2.Task
}
var file_boss_v2_register_task_proto_depIdxs = []int32{
	2, // 0: boss.v2.RegisterTaskResponse.task:type_name -> boss.v2.Task
...
func init() { file_boss_v2_register_task_proto_init() }
func file_boss_v2_register_task_proto_init() {
	if File_boss_v2_register_task_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_boss_v2_register_task_proto_rawDesc), len(file_boss_v2_register_task_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_boss_v2_register_task_proto_goTypes,
		DependencyIndexes: file_boss_v2_register_task_proto_depIdxs,
		MessageInfos:      file_boss_v2_register_task_proto_msgTypes,
	}.Build()
	File_boss_v2_register_task_proto = out.File
	file_boss_v2_register_task_proto_goTypes = nil
	file_boss_v2_register_task_proto_depIdxs = nil
}
